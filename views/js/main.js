...
var resizePizzas = function(size) {
  ...
  // Keep track of the window width in a variable so we don't have to access it in a loop multiple times
  var windowwidth = document.querySelector("#randomPizzas").offsetWidth;

  // Returns the size of a pizza element based on number chosen. Called by changePizzaSizes(size).
  ...
  function changePizzaSizes(size) {
    // set the width as a percent into a variable to cache for the loop.
...
function updatePositions() {
  ...
  // calculate the scroll position once for all mover items.
